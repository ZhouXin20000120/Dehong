	...
	<div id="menubar">
		<div id="middleMenubar">
			<div id="innerMenubar">
				<div id="navMenubar">
					<ul>
						<li id="save"><a href="#" onclick="formSubmit('addpro.action','_self');">确定</a></li>
...
<div>
	...
	<div class="eXtremeTable">
		<table id="ec_table" class="tableRegion" width="98%">
			...
			<c:forEach items="${contractProList}" var="o" varStatus="status">
				<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'">
					...
					<td>${o.amount}</td>
					<td>
						<a href="/findbyContractPro.action?CONTRACT_PRODUCT_ID=${o.CONTRACT_PRODUCT_ID}">{修改}</a>
						<a href="/deleteContractPro.action?CONTRACT_PRODUCT_ID=${o.CONTRACT_PRODUCT_ID}">{删除}</a>
						<a href="/findextpro.action?CONTRACT_PRODUCT_ID=${o.CONTRACT_PRODUCT_ID}">{附件}</a>
					</td>
				</tr>
			</c:forEach>
			</tbody>

...
<body>
<form method="post">
	<input type="hidden" name="factory_id" value="${obj.factory_id}"/>
...
<div id="innerMenubar">
    <div id="navMenubar">
<ul>
<li id="save"><a href="#" onclick="formSubmit('updateoryy.action','_self');">确定</a></li>
    ...
    <div>
		<table class="commonTable" cellspacing="1">
	        <tr>
	            ...
	            <td class="tableContent"><input type="text" name="full_name" value="${obj.full_name}"/></td>
	            <td class="columnTitle_mustbe">简称：</td>
	            <td class="tableContent"><input type="text" name="factory_name" value="${obj.factory_name}"/></td>
	        </tr>
	        <tr>
	            <td class="columnTitle_mustbe">联系人：</td>
	            <td class="tableContent"><input type="text" name="contactor" value="${obj.contactor}"/></td>
